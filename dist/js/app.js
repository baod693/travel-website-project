...
function hotelInfo (cardInformation){
    ...
    .then(response => response.json())
    .then(data => {
            let hotelInfoJSON = JSON.stringify(data); 
...
function tourInfo (cardInformation){
    ...
    .then(response => response.json())
    .then(data => {
            let tourInfoJSON = JSON.stringify(data); 
...
function nightlifeInfo (cardInformation){
    ...
    .then(response => response.json())
    .then(data => {
            let nightlifeInfoJSON = JSON.stringify(data); 
...
function sightSeeingInfo (cardInformation){
    ...
    .then(data => {
        console.log(cardInformation);
            let sightSeeingInfoJSON = JSON.stringify(data); 
